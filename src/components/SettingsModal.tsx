...
import { Settings, X, Sparkles, Volume2, VolumeX, Keyboard } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div className="bg-[#121622] border border-amber-500/25 rounded-2xl max-w-md w-full p-6 shadow-[0_20px_60px_rgba(0,0,0,0.9)] relative text-slate-100">
        ...
        <div className="flex items-center gap-3.5 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-white">Lounge Settings</h2>
            <p className="text-xs text-slate-400">Personalize animations, audio playback, and controls.</p>
          </div>
        </div>

        <div className="flex flex-col gap-4">
          {/* Setting 1: Word Correct Animation Toggle */}
          <div className="flex items-center justify-between p-3.5 rounded-xl bg-[#181e2c] border border-white/5">
          ...
          <div className="p-3.5 rounded-xl bg-[#181e2c] border border-white/5 flex flex-col gap-2.5">
          ...
          <div className="p-3.5 rounded-xl bg-[#151926] border border-white/5 flex flex-col gap-2">
            ...
            <div className="grid grid-cols-2 gap-2 pt-1 text-[11px]">
              <div className="flex items-center justify-between bg-black/40 px-2 py-1 rounded border border-white/5">
                ...
                <kbd className="px-1.5 py-0.2 rounded bg-[#1c2232] text-amber-300 font-mono font-bold text-[10px]">Space</kbd>
              </div>
              <div className="flex items-center justify-between bg-black/40 px-2 py-1 rounded border border-white/5">
                <span className="text-slate-400">Reveal Word</span>
                <kbd className="px-1.5 py-0.2 rounded bg-[#1c2232] text-amber-300 font-mono font-bold text-[10px]">Tab</kbd>
              </div>
              <div className="flex items-center justify-between bg-black/40 px-2 py-1 rounded border border-white/5 col-span-2">
                ...
                <kbd className="px-1.5 py-0.2 rounded bg-[#1c2232] text-amber-300 font-mono font-bold text-[10px]">Shift + Tab</kbd>
              </div>
            </div>
          </div>
        </div>
